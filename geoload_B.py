...
# Download the code from http://www.py4e.com/code3/geodata.zip - then unzip
# the file and edit where.data to add an address nearby where you live -
...
# Then run geodump.py to read the database and produce where.js. You can run
# the programs and then scroll back to take your screen shots when the program
# finishes. Then open where.html to visualize the map. Take screen shots as
# described below. Make sure that your added location shows in all three
...
#api_key = 'AIzaS____________________e4U'
