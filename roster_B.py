...
# IMPORTANT: Download and use the specifc file created only for YOU. If you use the
# the file in the /code3/roster/ directorry your program will FAIL!
# Hint code strats with 416!
...
#print to check that the content has been properly extracted
    print((name, title, role))

# print data from JASO file into the tables
